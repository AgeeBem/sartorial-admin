      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card className="cursor-pointer hover:border-slate-300 transition-colors">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div><h3 className="font-semibold text-sm">Security</h3>                                <p className="text-xs text-slate-600">Access control, sessions, MFA</p></div>
          </CardContent>
        </Card>
        <Card className="cursor-pointer hover:border-slate-300 transition-colors">
          <CardContent className="p-6 flex items-center gap-4">
            <div className="rounded-lg bg-emerald-100 p-3"><Bell size={20} className="text-emerald-600" /></div>
            <div><h3 className="font-semibold text-sm">Notifications</h3>                            <p className="text-xs text-slate-600">Email alerts, webhooks</p></div>
          </CardContent>
        </Card>
        <Card className="cursor-pointer hover:border-slate-300 transition-colors">
          <CardContent className="p-6 flex items-center gap-4">
            <div className="rounded-lg bg-amber-100 p-3"><Palette size={20} className="text-amber-600" /></div>
            <div><h3 className="font-semibold text-sm">Appearance</h3>                            <p className="text-xs text-slate-600">Theme, branding, localization</p></div>
          </CardContent>
        </Card>
      </div>
      <Card className="mt-6">
        ...
        <CardContent>
          <p className="text-sm text-slate-600">API key management coming soon.</p>
        </CardContent>
      </Card>
    </AppShell>
  )
